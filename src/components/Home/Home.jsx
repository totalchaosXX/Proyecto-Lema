...
const Home = () => {
  ...
  <header className="fixed right-0 top-0 left-60 bg-gray-50 py-3 px-4 h-16">
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <button type="button" className="flex items-center focus:outline-none rounded-lg text-gray-600 hover:text-gray-600 focus:text-gray-600 font-semibold p-2 border border-transparent hover:border-gray-300 focus:border-gray-300 transition">
    ...
    <div className="flex flex-col justify-between h-full">
      <div className="flex-grow">
        <div className="px-4 py-6 text-center border-b">
          <h1 className="text-xl font-bold leading-none"><span className="text-gray-700">Proyecto Lema</span> </h1>
        </div>
        <div className="p-4">
          <ul className="space-y-1">
            <li>
              <a href="javascript:void(0)" className="flex items-center bg-gray-200 rounded-xl font-bold text-sm text-gray-900 py-3 px-4">
            ...
            <li>
              <a href="javascript:void(0)" className="flex bg-white hover:bg-gray-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-lg mr-4" viewBox="0 0 16 16">
      ...
      <div className="p-4">
        ...
        </button> <a className="cursor-pointer" onClick={handleLogout}><span className="font-bold text-sm ml-2">Cerrar sesión</span></a>
      </div>
    </div>
  </aside>
        ...
        <div className="bg-white rounded-3xl p-8 mb-5">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-stretch">
              <div className="text-gray-400 text-xs">Members connected</div>
          ...
          <div className="grid grid-cols-2 gap-x-20">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gray-100 rounded-xl text-gray-800">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
                  ...
                  <a href="javascript:void(0)" className="font-bold hover:text-gray-800 hover:underline">Blog and social posts</a>
                ...
                <div className="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
                  ...
                  <a href="javascript:void(0)" className="font-bold hover:text-gray-800 hover:underline">New campaign review</a>
                  <div className="text-sm text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-gray-800 inline align-middle mr-1" viewBox="0 0 16 16">
                      <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                    </svg>New feedback
                ...
                <div className="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
                  ...
                  <a href="javascript:void(0)" className="font-bold hover:text-gray-800 hover:underline">Cross-platform and browser QA</a>
                </div>
